...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cqgfl48.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cqgfl48.containers.anotherwebservice.com/
...
```
git clone git@github.com:monitoreoinfrait/container-cqgfl48.git
cd container-cqgfl48
```
...
```
docker attach container-cqgfl48
```
